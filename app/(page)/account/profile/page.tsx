    ...
    return (
        <div className="w-full  ">
            <div className="max-w-3xl w-full flex flex-col gap-5">
                <h2 className="text-3xl font-extrabold text-text mb-8 font-poppins tracking-tight">Profile Overview</h2>
                <div className="w-full flex justify-center " >
                    <div className="bg-white w-full rounded-3xl p-8 md:p-10 border border-zinc-200 shadow-sm relative overflow-hidden">
                        ...
                        <button
                            ...
                            className="absolute top-6 right-6 p-2.5 text-zinc-400 hover:text-white hover:bg-[#7C6A46] rounded-full transition-all duration-300 shadow-sm"
                            title="Edit Profile"
                        >
                        ...
                        <div className="flex items-center gap-6 mb-10 mt-2">
                            <div className="w-20 h-20 bg-[#faf8f5] rounded-full flex items-center justify-center text-3xl text-[#7C6A46] border border-[#e2dcd0]/50 font-poppins font-bold shadow-inner overflow-hidden">
                                {session?.user?.image ? (
                                    <Image
                            ...
                            <div>
                                <h3 className="text-2xl font-bold text-text font-poppins">{guest?.fullName || 'Guest User'}</h3>
                                <p className="text-zinc-500 font-mulish mt-0.5">{guest?.email}</p>
                            </div>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-zinc-100 pt-8">
                            <div className="flex flex-col gap-1.5">
                                <span className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest">National ID / Passport</span>
                                <span className="text-[15px] font-medium text-zinc-800 font-mulish">
                                    {guest?.nationalID || <span className="text-zinc-400 italic">Not provided</span>}
                                </span>
                            </div>

                            <div className="flex flex-col gap-1.5">
                                <span className="text-[11px] font-bold text-zinc-400 uppercase tracking-widest">Nationality</span>
                        ...
                        <div className="pt-8 mt-8 border-t border-zinc-100">
                            <div className="text-[10px] text-zinc-400 font-mulish uppercase tracking-widest flex flex-col sm:flex-row gap-4 sm:gap-8">
